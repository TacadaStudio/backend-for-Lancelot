...
description: Provides best practices and patterns for error handling in various programming languages (Python, TypeScript, Rust, Go). Use this skill when implementing robust error handling, designing APIs, or debugging issues.
---
